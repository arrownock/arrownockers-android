...
public class ArcLayout extends ViewGroup {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		int quarterR = (int) (width * 0.25);
		final int radius = mRadius = computeRadius(
				Math.abs(mToDegrees - mFromDegrees), getChildCount(),
				mChildSize, mChildPadding, quarterR);
		// final int radius = mRadius = computeRadius(Math.abs(mToDegrees -
		// mFromDegrees), getChildCount(), mChildSize,
