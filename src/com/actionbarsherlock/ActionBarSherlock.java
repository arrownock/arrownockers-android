...
public abstract class ActionBarSherlock {
    ...
    protected ActionBarSherlock(Activity activity, int flags) {
        if (DEBUG) Log.i(TAG, "[<ctor>] activity: " + activity + ", flags: " + flags);
    ...
    protected final boolean callbackCreateOptionsMenu(Menu menu) {
        if (DEBUG) Log.i(TAG, "[callbackCreateOptionsMenu] menu: " + menu);
        ...
        if (DEBUG) Log.i(TAG, "[callbackCreateOptionsMenu] returning " + result);
        return result;
    }
    ...
    protected final boolean callbackPrepareOptionsMenu(Menu menu) {
        if (DEBUG) Log.i(TAG, "[callbackPrepareOptionsMenu] menu: " + menu);
        ...
        if (DEBUG) Log.i(TAG, "[callbackPrepareOptionsMenu] returning " + result);
        return result;
    }
    ...
    protected final boolean callbackOptionsItemSelected(MenuItem item) {
        if (DEBUG) Log.i(TAG, "[callbackOptionsItemSelected] item: " + item.getTitleCondensed());
        ...
        if (DEBUG) Log.i(TAG, "[callbackOptionsItemSelected] returning " + result);
        return result;
    }
    ...
    public void setContentView(View view) {
        if (DEBUG) Log.i(TAG, "[setContentView] view: " + view);
    ...
    public void setTitle(int resId) {
        if (DEBUG) Log.i(TAG, "[setTitle] resId: " + resId);
    ...
    public MenuInflater getMenuInflater() {
        if (DEBUG) Log.i(TAG, "[getMenuInflater]");
