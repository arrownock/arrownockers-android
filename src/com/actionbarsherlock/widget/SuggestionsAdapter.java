...
//    });
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence constraint) {
        if (DBG) Log.i(LOG_TAG, "runQueryOnBackgroundThread(" + constraint + ")");
    ...
    public void notifyDataSetChanged() {
        if (DBG) Log.i(LOG_TAG, "notifyDataSetChanged");
    ...
    public void notifyDataSetInvalidated() {
        if (DBG) Log.i(LOG_TAG, "notifyDataSetInvalidated");
    ...
    private void updateSpinnerState(Cursor cursor) {
        ...
        if (DBG) {
            Log.i(LOG_TAG, "updateSpinnerState - extra = "
                    + (extras != null
    ...
    public void changeCursor(Cursor c) {
        if (DBG) Log.i(LOG_TAG, "changeCursor(" + c + ")");
    ...
    private Drawable checkIconCache(String resourceUri) {
        ...
        if (DBG) Log.i(LOG_TAG, "Found icon in cache: " + resourceUri);
