    ...
    */
    ...
    View.OnKeyListener mTextKeyListener = new View.OnKeyListener() {
        public boolean onKey(View v, int keyCode, KeyEvent event) {
            ...
            if (DBG) {
                Log.i(LOG_TAG, "mTextListener.onKey(" + keyCode + "," + event + "), selection: "
    ...
    private final OnItemClickListener mOnItemClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            if (DBG) Log.i(LOG_TAG, "onItemClick() position " + position);
    ...
    private final OnItemSelectedListener mOnItemSelectedListener = new OnItemSelectedListener() {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            if (DBG) Log.i(LOG_TAG, "onItemSelected() position " + position);
