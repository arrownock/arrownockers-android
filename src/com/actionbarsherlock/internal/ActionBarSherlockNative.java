...
public class ActionBarSherlockNative extends ActionBarSherlock {
    ...
    public boolean dispatchCreateOptionsMenu(android.view.Menu menu) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[dispatchCreateOptionsMenu] menu: " + menu);
        ...
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[dispatchCreateOptionsMenu] returning " + result);
        return result;
    }

    @Override
    public boolean dispatchPrepareOptionsMenu(android.view.Menu menu) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[dispatchPrepareOptionsMenu] menu: " + menu);
    ...
    public boolean dispatchOptionsItemSelected(android.view.MenuItem item) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[dispatchOptionsItemSelected] item: " + item.getTitleCondensed());
        ...
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[dispatchOptionsItemSelected] returning " + result);
        return result;
    }

    @Override
    public boolean hasFeature(int feature) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[hasFeature] feature: " + feature);
    ...
    public boolean requestFeature(int featureId) {
        ...
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[requestFeature] returning " + result);
        return result;
    }
