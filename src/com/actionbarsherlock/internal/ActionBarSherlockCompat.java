...
import com.arrownock.opensource.arrownockers.BuildConfig;
...
public class ActionBarSherlockCompat extends ActionBarSherlock implements MenuBuilder.Callback, com.actionbarsherlock.view.Window.Callback, MenuPresenter.Callback, android.view.MenuItem.OnMenuItemClickListener {
    ...
    public ActionBar getActionBar() {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[getActionBar]");
    ...
    private void initActionBar() {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[initActionBar]");
    ...
    public void setTitle(CharSequence title) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[setTitle] title: " + title);
    ...
    public ActionMode startActionMode(ActionMode.Callback callback) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[startActionMode] callback: " + callback);
    ...
    public void dispatchConfigurationChanged(Configuration newConfig) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[dispatchConfigurationChanged] newConfig: " + newConfig);
    ...
    public void dispatchPostResume() {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[dispatchPostResume]");
    ...
    public void dispatchPause() {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[dispatchPause]");
    ...
    public void dispatchStop() {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[dispatchStop]");
    ...
    public void dispatchInvalidateOptionsMenu() {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[dispatchInvalidateOptionsMenu]");
    ...
    public boolean dispatchOpenOptionsMenu() {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[dispatchOpenOptionsMenu]");
    ...
    public boolean dispatchCloseOptionsMenu() {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[dispatchCloseOptionsMenu]");
    ...
    public void dispatchPostCreate(Bundle savedInstanceState) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[dispatchOnPostCreate]");
    ...
    public boolean dispatchCreateOptionsMenu(android.view.Menu menu) {
        if (BuildConfig.DEBUG) {
            Log.i(TAG, "[dispatchCreateOptionsMenu] android.view.Menu: " + menu);
            Log.i(TAG, "[dispatchCreateOptionsMenu] returning true");
        }
        return true;
    }
    ...
    public boolean dispatchPrepareOptionsMenu(android.view.Menu menu) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[dispatchPrepareOptionsMenu] android.view.Menu: " + menu);
        ...
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[dispatchPrepareOptionsMenu] returning " + result);
        return result;
    }
    ...
    public boolean dispatchMenuOpened(int featureId, android.view.Menu menu) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[dispatchMenuOpened] featureId: " + featureId + ", menu: " + menu);
    ...
    public void dispatchPanelClosed(int featureId, android.view.Menu menu){
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[dispatchPanelClosed] featureId: " + featureId + ", menu: " + menu);
    ...
    public void dispatchTitleChanged(CharSequence title, int color) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[dispatchTitleChanged] title: " + title + ", color: " + color);
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[dispatchKeyEvent] event: " + event);
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            if (mActionMode != null) {
                ...
                if (ActionBarSherlock.DEBUG) Log.i(TAG, "[dispatchKeyEvent] returning true");
                return true;
            }
        ...
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[dispatchKeyEvent] returning false");
        return false;
    }
    ...
    public boolean onMenuItemClick(android.view.MenuItem item) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[mNativeItemListener.onMenuItemClick] item: " + item);
    ...
    public void setProgressBarVisibility(boolean visible) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[setProgressBarVisibility] visible: " + visible);
    ...
    public void setProgressBarIndeterminateVisibility(boolean visible) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[setProgressBarIndeterminateVisibility] visible: " + visible);
    ...
    public void setProgressBarIndeterminate(boolean indeterminate) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[setProgressBarIndeterminate] indeterminate: " + indeterminate);
    ...
    public void setProgress(int progress) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[setProgress] progress: " + progress);
    ...
    public void setSecondaryProgress(int secondaryProgress) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[setSecondaryProgress] secondaryProgress: " + secondaryProgress);
    ...
    private int getFeatures() {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[getFeatures] returning " + mFeatures);
    ...
    public boolean hasFeature(int featureId) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[hasFeature] featureId: " + featureId);

        boolean result = (mFeatures & (1 << featureId)) != 0;
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[hasFeature] returning " + result);
        return result;
    }

    @Override
    public boolean requestFeature(int featureId) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[requestFeature] featureId: " + featureId);
    ...
    public void setUiOptions(int uiOptions) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[setUiOptions] uiOptions: " + uiOptions);
    ...
    public void setUiOptions(int uiOptions, int mask) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[setUiOptions] uiOptions: " + uiOptions + ", mask: " + mask);
    ...
    public void setContentView(int layoutResId) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[setContentView] layoutResId: " + layoutResId);
    ...
    public void setContentView(View view, ViewGroup.LayoutParams params) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[setContentView] view: " + view + ", params: " + params);
    ...
    public void addContentView(View view, ViewGroup.LayoutParams params) {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[addContentView] view: " + view + ", params: " + params);
    ...
    private void installDecor() {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[installDecor]");
    ...
    private ViewGroup generateLayout() {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[generateLayout]");
        ...
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[generateLayout] using screen XML " + mActivity.getResources().getString(layoutResource));
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if ("application".equals(name)) {
                        ...
                        if (ActionBarSherlock.DEBUG) Log.i(TAG, "Got <application>");

                        for (int i = xml.getAttributeCount() - 1; i >= 0; i--) {
                            if (ActionBarSherlock.DEBUG) Log.i(TAG, xml.getAttributeName(i) + ": " + xml.getAttributeValue(i));
                        ...
                        if (ActionBarSherlock.DEBUG) Log.i(TAG, "Got <activity>");
    ...
    public void ensureActionBar() {
        if (ActionBarSherlock.DEBUG) Log.i(TAG, "[ensureActionBar]");
